...
dot <user.text_code_codesaway>:                 insert('.{user.formatted_text(text_code_codesaway, "camel")}')
var <user.text_code_codesaway>:                 insert(user.formatted_text(text_code_codesaway, "camel"))
...
no args:                                        insert('()')
return <user.text_code_codesaway>:              insert('return {user.formatted_text(text_code_codesaway, "camel")}')
...
state <user.code_type> <user.text_code_codesaway>: insert('{code_type} {user.formatted_text(text_code_codesaway, "camel")}')
# Use defined types (handles HashMap correctly versus Hashmap)
diamond <user.code_type>:                       insert('{code_type}<>')
diamond <user.text_code_codesaway>:             insert('{user.formatted_text(text_code_codesaway, "hammer")}<>')
